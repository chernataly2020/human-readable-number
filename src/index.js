...
module.exports = function toReadable(number) {
    ...
    if (numStr.length > 9) {
        throw new Error('overflow') // Нельзя конвертировать 10тизначное число и более
    }

    const [, n1, n2, n3, n4, n5] = ('000000000' + numStr).substr(-9).match(regex) // слева добавлены нули
        /*формирование ответа*/
    let str = '';
